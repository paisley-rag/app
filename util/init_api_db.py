...
- currently unused (using JWT auth instead of API key auth)
'''
import os
import hashlib
import random
...
api_db_data = {
    "id0": {
        "name": digest('admin'),
        "pw": ("$argon2id$v=19$m=65536,t=3,p="
            "4$94csP7TfX/0v7Ogvj13lzw$oyGbZPx2TVnywdX8AxhWREM8dJf1diOkYZW+DnU5viQ"),
        "api_key": "272de67e6ab46cd6c09cd5149e7e5889"
    },
    "id1": {
        "name": digest('bob'),
        "pw": ("$argon2id$v=19$m=65536,t=3,p="
            "4$3KdzGOGDCC+HD25As7f5yA$sl4bP3DMd7AgFvk4SOkOSZUipuk3Q6j41+tyWlvsGXs"),
